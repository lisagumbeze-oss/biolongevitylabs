...
import { hasStoredConsent, storeConsent } from "@/lib/consent-storage";
...
const ConsentModal = () => {
    ...
    const handleYes = () => {
        ...
        // Persist so this device is not prompted again on future visits.
        storeConsent();
    ...
    if (!consentChecked || !isVisible) return null;
                            ...
                            <label className="flex items-center gap-2 cursor-default">
                                <div className="relative flex items-center justify-center">
                                    <input
                                        ...
                                        tabIndex={-1}
                                        aria-hidden
                                        className="peer appearance-none w-4 h-4 border-2 border-primary rounded bg-primary cursor-default"
                                    />
                                ...
                                <span className="font-medium text-slate-500 dark:text-slate-400">Remember me on this device</span>
                            </label>
