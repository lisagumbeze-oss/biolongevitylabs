    ...
    <div className="flex flex-col">
          ...
          <nav aria-label="Key research catalog links" className="flex flex-wrap gap-3 text-sm font-bold">
            ...
            {TOP_PRODUCT_LINKS.map((link) => (
              <React.Fragment key={link.href}>
                <span className="text-slate-300">·</span>
                <Link href={link.href} className="text-slate-600 dark:text-slate-400 hover:text-primary">
                  {link.label}
                </Link>
              </React.Fragment>
            ))}
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 bg-slate-900">
          <div className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_50%_50%,rgba(99,102,241,0.4),transparent_70%)]" />
        </div>
        <motion.div
          initial="hidden"
          whileInView="visible"
          ...
          <div className="bg-white/5 backdrop-blur-2xl rounded-[3rem] border border-white/10 p-8 sm:p-16 flex flex-col lg:flex-row items-center gap-12 sm:gap-20">
            <div className="flex-1 text-center lg:text-left">
              ...
              <h2 className="text-4xl sm:text-6xl font-black text-white tracking-tighter mb-8 leading-tight">
                ...
                <span className="text-primary italic">start your research?</span>
              </h2>
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 text-center">
            ...
            <motion.div variants={fadeInUp} className="flex flex-col items-center group">
              ...
              <p className="mt-3 text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                Synthesized in USA-registered facilities following Good Manufacturing Practices. Full chain of
